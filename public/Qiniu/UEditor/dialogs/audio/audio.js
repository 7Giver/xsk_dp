        ...
        initUploader: function() {
            var _this = this,
                ...
                actionUrl = editor.getActionUrl(
                    editor.getOpt("audioActionName")
                ),
                acceptExtensions = (editor.getOpt("audioAllowFiles") || [])
                    .join("")
                    .replace(/\./g, ",")
                    .replace(/^[,]/, ""),
            ...
            uploader.on("uploadBeforeSend", function(file, data, header) {
                ...
                // HaoChuan9421
                if (
                    editor.options.headers &&
                    Object.prototype.toString.apply(editor.options.headers) ===
                        "[object Object]"
                ) {
